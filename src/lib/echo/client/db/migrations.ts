...
import postInitialSyncFtsIndex from "./migrations-client/post-initial-sync-fts-index.sql?raw";
import postInitialSyncIndexes from "./migrations-client/post-initial-sync-indexes.sql?raw";
